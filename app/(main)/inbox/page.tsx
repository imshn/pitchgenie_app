...
import { Search, Inbox, Send, AlertCircle, RefreshCw, Lock, Mail } from "lucide-react";
...
export default function InboxPage() {
    ...
    // Plan Enforcement
    const isPlanAllowed = plan?.planId !== "free";
    ...
    useEffect(() => {
        ...
        // If plan not allowed, stop loading
        if (!isPlanAllowed) {
            setLoading(false);
            return;
        }
